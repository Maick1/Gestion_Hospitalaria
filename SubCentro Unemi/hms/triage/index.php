...
if (isset($_POST['submit'])) {
    $triageUsername = $_POST['username'];
    $triagePassword = $_POST['password'];

    $query = "SELECT * FROM triage WHERE triageUsername='$triageUsername'";
    $result = mysqli_query($con, $query);

    if ($result && mysqli_num_rows($result) > 0) {
        $triageData = mysqli_fetch_assoc($result);

        if (password_verify($triagePassword, $triageData['triagePassword'])) {
            // Contraseña válida
            $_SESSION['elogin'] = $triageUsername;
            $_SESSION['id'] = $triageData['id'];
            $extra = "dashboard.php";
...
<head>
	...
	<link rel="icon" type="image/png" href="../triage//assets//images//en.png" />
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				...
				<a href="../../index.html">
					<center>
						<h2>SubCentro Unemi | Enfermera Login</h2>
					</center>
				</a>
			</div>
			<div class="centered-image">
				<img src="../triage//assets//images//en.png" alt="Descripción de la imagen">
			</div>
