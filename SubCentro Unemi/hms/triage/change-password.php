...
<head>
	...
	<link rel="icon" type="image/png" href="../doctor//assets//images//cp.png" />
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Doctor(a) | CAMBIAR CONTRASEÑA</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Doctor(a)</span>
											...
											<div class="panel-body">
												...
												<form role="form" name="chngpwd" method="post" onSubmit="return valid();">
													...
													<div class="form-group">
														...
														<input type="password" name="npass" class="form-control" placeholder="Introducir nueva contraseña">
													</div>
													...
													<div class="form-group">
														...
														<input type="password" name="cfpass" class="form-control" placeholder="Introducir contraseña">
													</div>
