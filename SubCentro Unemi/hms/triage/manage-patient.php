...
<head>
    ...
    <link rel="icon" type="image/png" href="../admin//assets//images//v1.png" />
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = mysqli_query($con, "SELECT * FROM tblpatient ORDER BY YEAR(STR_TO_DATE(CreationDate, '%Y-%m-%d %H:%i:%s')) DESC, STR_TO_DATE(CreationDate, '%Y-%m-%d %H:%i:%s') DESC");
                                        $cnt = 1;
