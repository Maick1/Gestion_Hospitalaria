							...
							<div class="col-md-12">
								...
								<table class="table table-hover" id="sample-table-1">
									<thead>
										<tr>
											<th class="center">#</th>
											<th class="hidden-xs">Nombre Doctor(a)</th>
									...
									<tbody>
										...
										?>
											...
											<tr>
												...
												<td>
													<?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) { ?>
														<a href="edit-appointment.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">
															Reagendar
														</a>
														<a href="appointment-history.php?id=<?php echo $row['id']; ?>&cancel=update" onClick="return confirm('¿Estás seguro de que deseas cancelar esta cita?')" class="btn btn-transparent btn-xs tooltips" title="Cancelar cita" tooltip-placement="top" tooltip="Cancelar">Cancelar</a>
													<?php } else { ?>
														<span class="btn btn-xs btn-disabled" disabled>Cancelar</span>
													<?php } ?>
												</td>
