...
<head>
	...
	<link rel="icon" type="image/png" href="../admin//assets//images//c.png" />
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Cambiar la contraseña</h1>
							</div>
											...
											<div class="panel-body">
												...
												<form role="form" name="chngpwd" method="post" onSubmit="return valid();">
													...
													<div class="form-group">
														...
														<input type="password" name="cfpass" class="form-control" placeholder="Confirmar la Contraseña">
													</div>
