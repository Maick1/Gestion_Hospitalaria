...
<head>
	...
	<title>Médicos Especialización </title>
	...
	<link rel="icon" type="image/png" href="../admin//assets//images//ag.png" />
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Agregar especialización médica</h1>
							</div>
					...
					<div class="container-fluid container-fullw bg-white">
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Administrar <span class="text-bold"> Especializaciónes Médicas</span></h5>
