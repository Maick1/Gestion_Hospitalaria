...
<head>
	...
	<link rel="icon" type="image/png" href="../admin//assets//images//co.png" />
...
<style>
	.StepTitle {
		font-size: 16px;
		/* Tamaño de fuente más pequeño, ajusta el valor según tus preferencias */
	}
</style>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Administador | Dashboard</h1>
							</div>
							<ol class="breadcrumb">
								<li>
					...
					<div class="container-fluid container-fullw bg-white">
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-user fa-stack-1x fa-inverse"></i>
										</span>
