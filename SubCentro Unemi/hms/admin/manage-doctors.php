			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<div class="container-fluid container-fullw bg-white">
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Listas de <span class="text-bold">Médicos</span></h5>
								...
								<table class="table table-hover" id="sample-table-1">
									<thead>
										<tr>
											...
											<th class="hidden-xs">Nombre Médicos</th>
											...
											<tr>
												...
												<td>
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														...
														<a href="manage-doctors.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('¿Estás segura de que quieres eliminar?')" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
													</div>
