...
<head>
	...
	<title>Registros de sesiones médicas</title>
	...
	<link rel="icon" type="image/png" href="../admin//assets//images//r1.png" />
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Registros de Sesiones Médicas</h1>
							</div>
						</div>
					</section>
					<!-- end: PAGE TITLE -->
